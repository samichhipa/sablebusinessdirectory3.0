package com.macinternetservices.sablebusinessdirectory.ui.notification.list;
...
import com.macinternetservices.sablebusinessdirectory.databinding.FragmentNotificationListBinding;
...
import com.macinternetservices.sablebusinessdirectory.ui.notification.list.adapter.NotificationListAdapter;
...
public class NotificationListFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
    ...
    private void replaceData(List<com.macinternetservices.sablebusinessdirectory.viewobject.Noti> notificationList) {
